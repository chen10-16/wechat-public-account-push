export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6a6262a56c4fad3d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5b6a1b4b861afa6dd793d34f6626b85a",
  ...
  USERS: [
    {
      ...
      id: " o71_86uqIE87R0j-mbxqeXii7FNw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "H2xNWj6WRX7k7NRlUwGBoCeHsh-uaUHYJiNsi5nzv5Y",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "泰安",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "孙国帅", "year": "2001", "date": "10-23"},
